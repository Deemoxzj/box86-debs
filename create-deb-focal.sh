...
for target in ${targets[@]}; do
 ...
 #   cmake .. -DARM64=1 -DBAD_SIGNAL=ON -DCMAKE_BUILD_TYPE=RelWithDebInfo -DARM_DYNAREC=ON -DCMAKE_C_COMPILER=arm-linux-gnueabihf-gcc-9 -DCMAKE_C_FLAGS=-marm || error "Failed to run cmake."
  else
